   ...
   <body onload="cpestana41(6);">
            ...
            <table id="main-rpt-crear" >
                <tr>
                    <td>
                        ...
                        <input name="opr" type="hidden"  value="crear-remision-rpto"/>
                        <input name="opr" type="hidden"  value="crear-remision-rpto"/>
                        </td></tr>
                        <tr  class="titulo"><td colspan="15">Crear remision</td></tr>
                        <tr class="encabezados"><td>Id</td><td>Fremision</td><td>Observacion</td><td>Autorizacion</td><td>Confrecibido</td><td>fcreacion</td><td>zona</td></tr>
                        <tr>
                        <td><input name="idremision" type="number"  value="<?php echo $sig_id_remision; ?>" disabled /></td>
                        <td><input name="fremision" type="date" value="<?php echo $fremision; ?>" enabled  required="required"/></td>
                        ...
                        <tr id="traddrepuesto">
                        <td><input name="id_detremision[]" type="number" value="<?php echo $id_detremision; ?>" disabled />
                        </td>
                        <td><input id="idrpt" name="id_repuesto[]" type="text" value="<?php ?>" enabled list="lstproducto"  required="required"/></td>
                        <td><input name="id_remision[]" type="number" value="<?php echo $sig_id_remision; ?>" disabled  /></td>
      ...
      <div id="cpestana4-1-1">
         <div id="crearcliente">
            ...
            <script>
               var tablac="remisionrpto"//tabla a la que se realizaran las consultas 
         	...
         	$.ajax({
         		...
         		error: function(){curnormal();},
         			success: function(data){
         				...
         				strcp+="<td><div class='btn' onclick='cargarremision2p("+data.elementos[el][0]+")'>"+"Ver rem"+"</div></td>";
         				strcp+="</tr>";
         				} 
         				strcp+="<tfoot>";
         				strcp+="<tr><td colspan='"+(numcampos+1)+"'>";
         ...
         -->                                                
            ...
            <div id="cpestana4-1-4">
             ...
             <div id="cpestana4-1-5">
               <table border="1" style="margin:auto;background-color:rgba(255,255,255,1);text-align:center;">
                  <tr>
                     <th colspan="2">Consultar Detalle de remision y Eliminar</th>
                  </tr>
                  <tr>
                     <td>Ingrese el id de la remision a Eliminar</td>
                  ...
                  <tr>
                     <td colspan="2">
							...
							if(confirm("Esta seguro Eliminar la rem id:"+idrem)){
								...
								//tabla a la que se realizaran las consultas 
									...
									$.ajax({
										...
										url: url,
										//data:{opr:'t',tor:'t'},
										data:{opr:'eliminarremisionrpto',idremision:idrem},
										beforeSend: function(){curcarg();},
										complete: function(){curnormal();},
										success: function(data){
											if(data.error==0){
                        ...
                        <div id="minremision5p">
                           <iframe id="framremision5p" dir=""></iframe>
                        </div>
                     </td>
                  </tr>
               </table>
